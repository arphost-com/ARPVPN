...
class ArpvpnApiClient:
    ...
    def mesh_diagnostics(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/diagnostics"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_dry_run(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/dry-run"
        return self._request("POST", path, params=params, payload=payload, headers=headers)

    def mesh_export(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/export"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_import(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/import"
        return self._request("POST", path, params=params, payload=payload, headers=headers)

    def mesh_links(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/links"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_create_link(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/links"
        return self._request("POST", path, params=params, payload=payload, headers=headers)

    def mesh_delete_link(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/links/{uuid}"
        return self._request("DELETE", path, params=params, payload=payload, headers=headers)

    def mesh_get_link(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/links/{uuid}"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_update_link(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/links/{uuid}"
        return self._request("PUT", path, params=params, payload=payload, headers=headers)

    def mesh_overview(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/overview"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_plan(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/plan"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_policies(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/policies"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_create_policy(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/policies"
        return self._request("POST", path, params=params, payload=payload, headers=headers)

    def mesh_delete_policy(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/policies/{uuid}"
        return self._request("DELETE", path, params=params, payload=payload, headers=headers)

    def mesh_get_policy(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/policies/{uuid}"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_update_policy(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/policies/{uuid}"
        return self._request("PUT", path, params=params, payload=payload, headers=headers)

    def mesh_policy_simulate(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/policy-simulate"
        return self._request("POST", path, params=params, payload=payload, headers=headers)

    def mesh_routes(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/routes"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_create_route(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/routes"
        return self._request("POST", path, params=params, payload=payload, headers=headers)

    def mesh_delete_route(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/routes/{uuid}"
        return self._request("DELETE", path, params=params, payload=payload, headers=headers)

    def mesh_get_route(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/routes/{uuid}"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_update_route(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/routes/{uuid}"
        return self._request("PUT", path, params=params, payload=payload, headers=headers)

    def mesh_topologies(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/topologies"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_create_topology(self, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = "/api/v1/mesh/topologies"
        return self._request("POST", path, params=params, payload=payload, headers=headers)

    def mesh_delete_topology(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/topologies/{uuid}"
        return self._request("DELETE", path, params=params, payload=payload, headers=headers)

    def mesh_get_topology(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/topologies/{uuid}"
        return self._request("GET", path, params=params, payload=payload, headers=headers)

    def mesh_update_topology(self, uuid, payload: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None) -> Any:
        path = f"/api/v1/mesh/topologies/{uuid}"
        return self._request("PUT", path, params=params, payload=payload, headers=headers)
