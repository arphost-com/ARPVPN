...
## Used vs Likely-Unused (Cleanup Candidates)

This is a practical cleanup list from current code/CI references.

### Likely unused files/assets

- `arpvpn/web/static/assets/demo/chart-area-demo.js`
- `arpvpn/web/static/assets/demo/chart-bar-demo.js`
- `arpvpn/web/static/assets/demo/chart-pie-demo.js`

These demo chart files are not referenced by templates or JS modules.

### Empty or placeholder paths

- `arpvpn.wiki/` (empty directory)
- `codecov.yml` (empty file)

### Not in always-on CI test target list

The following tests exist but are not in default `unit_tests` + `api_contract_tests` target lists (they still run if full optional integration suite is enabled):

- `arpvpn/tests/default/test_documentation_page.py`
- `arpvpn/tests/default/test_interface.py`
- `arpvpn/tests/default/test_mfa.py`
- `arpvpn/tests/default/test_peers.py`
- `arpvpn/tests/default/test_rrd_graphs_access.py`
- `arpvpn/tests/default/test_settings.py`
- `arpvpn/tests/default/test_tenancy_phase1.py`
- `arpvpn/tests/default/test_tls_manager.py`

### Potential documentation drift

- `docs/source/changelog.rst` currently reflects older 0.x/1.x era entries and does not document recent 2.x work.
