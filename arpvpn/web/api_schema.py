...
API_REQUEST_SCHEMAS: Dict[str, ApiRequestSchema] = {
    ...
    "api_create_user": ApiRequestSchema(fields={
        ...
        "role": string_field(enum=ROLE_ENUM, example="client"),
        "tenant_id": string_field(example="tenant-123"),
        "create_peer": boolean_field(example=True),
        "peer_interface": string_field(example="wg0"),
        "peer_mode": string_field(enum=("client", "site_to_site"), example="client"),
        "peer_enabled": boolean_field(example=True),
        "peer_nat": boolean_field(example=False),
        "peer_full_tunnel": boolean_field(example=False),
        "peer_description": string_field(example="Provisioned via API"),
        "peer_ipv4": string_field(example="10.10.0.2/32"),
        "peer_dns1": string_field(example="8.8.8.8"),
        "peer_dns2": string_field(example="1.1.1.1"),
        "peer_site_to_site_subnets": string_list_field(),
    }),
